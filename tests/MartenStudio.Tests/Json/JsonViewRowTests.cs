...
/// <summary>One row of the flat model, and its own interop: taking DOM focus when the keyboard moves onto it.</summary>
public class JsonViewRowTests
{
    [Fact]
    public void A_lost_circuit_moving_keyboard_focus_onto_the_row_does_not_escape_render()
    {
        ...
        Action render = () => context.Render<JsonViewRow>(p => p.Add(c => c.AutoFocus, true));
